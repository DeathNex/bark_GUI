++ Setup instructions for Bark_GUI.exe
++ Setup instructions for bark.exe

Αρχείο κειμένου readme.txt με σαφείς οδηγίες για τον εν δυνάμει λειτουργικό έλεγχο του παραδοτέου από τρίτον,
 δηλαδή, εκδόσεις των λογισμικών που χρησιμοποιήθηκαν (λειτουργικό σύστημα, γλώσσα προγραμματισμού,
 βιβλιοθήκες, πιθανά σύνολα δεδομένων – datasets), τυχόν μη προφανείς απαιτήσεις της εγκατάστασης
 των λογισμικών, ιδιαίτερες ρυθμίσεις που απαιτήθηκαν (π.χ. σε κάποιον web server, γλώσσα προγραμματισμού,
 compiler), κτλ.
