...
{
    public partial class control_keyword : custom_control
    {
        public control_keyword(string name, List<string> options, bool required, string help, General_Control generalControl)
